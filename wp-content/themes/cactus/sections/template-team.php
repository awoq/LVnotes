...
?>
  ...
  <div class="cactus-section-content">
    <div class="team_container_selective <?php echo $container;?>">
      <h2 class="cactus-section-title text-center <?php echo 'section_title_'.$cactus_section_key.'_selective '.$cactus_animation;?>" data-animationduration="0.4" data-animationtype="fadeInUp"><?php echo wp_kses( $section_title , $allowedposttags );?></h2>
      ...
      <?php if( $style == '1' ){?>
        <li>
          <div class="cactus-team-item <?php echo $cactus_animation;?>" data-animationduration="<?php echo $time;?>" data-animationtype="fadeInUp"> <img src="<?php echo esc_url($item['avatar']);?>" alt="<?php echo esc_attr($item['name']);?>">
          <?php if($item['link']!=''){?>
        ...
        <?php }else{ ?>
        <li>
          <div class="cactus-team-item <?php echo $cactus_animation;?>" data-animationduration="<?php echo $time;?>" data-animationtype="fadeInUp">
              <?php if($item['link']!=''){?>
          <a href="<?php echo esc_url($item['link']);?>">
