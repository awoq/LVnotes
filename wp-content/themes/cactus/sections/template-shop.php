...
<div class="cactus-section-content">
  <div class="cactus-container">
    ...
    <?php if($button_text!=''):?>
    <div class="cactus-action text-center <?php echo $cactus_animation;?>" data-animationduration="0.9" data-animationtype="fadeInUp"> <a class="button_link_shop_selective" href="<?php echo esc_url($button_link);?>"><span class="cactus-btn primary <?php echo 'button_text_'.$cactus_section_key.'_selective';?>"><?php echo esc_attr($button_text);?></span></a> </div>
    <?php endif;?>
  </div>
</div>
