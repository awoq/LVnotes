      ...
      <div class="cactus-box left <?php echo $hide1;?>">
        ...
        <div class="cactus-box-inner">
          <div class="cactus-box-content">
            ...
            <p class="cactus-section-desc text-left <?php echo 'section_subtitle_'.$cactus_section_key.'_selective '.$cactus_animation;?>" data-animationduration="0.6" data-animationtype="fadeInUp"><?php echo wp_kses( do_shortcode($section_subtitle) , $allowedposttags );?></p>
            <div class="cactus-promo <?php echo 'text_'.$cactus_section_key.'_selective '.$cactus_animation;?>" data-animationduration="0.7" data-animationtype="fadeInUp"><?php echo wp_kses( do_shortcode($text) , $allowedposttags );?></div>
             <?php if($button_text!=''):?>
        ...
        <div class="cactus-box-inner">
          <div class="cactus-box-content">
            <h2 class="cactus-section-title text-left <?php echo 'section_title_'.$cactus_section_key.'_selective '.$cactus_animation;?>" data-animationduration="0.4" data-animationtype="fadeInUp"><?php echo wp_kses( $section_title , $allowedposttags );?></h2>
            <p class="cactus-section-desc text-left <?php echo 'section_subtitle_'.$cactus_section_key.'_selective '.$cactus_animation;?>" data-animationduration="0.6" data-animationtype="fadeInUp"><?php echo wp_kses( do_shortcode($section_subtitle) , $allowedposttags );?></p>
            <div class="cactus-promo <?php echo 'text_'.$cactus_section_key.'_selective '.$cactus_animation;?>" data-animationduration="0.8" data-animationtype="fadeInUp"><?php echo wp_kses( do_shortcode($text) , $allowedposttags );?></div>
             <?php if($button_text!=''):?>
