...
class CactusVideo {
  ...
  private function render_vimeo_player() {
    echo '<iframe src="//player.vimeo.com/video/'. $this->get_vimeo_ref_from_url() .'?autoplay='. $this->autoplay .'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
  }
  ...
  private function render_youtube_player() {
    echo '<iframe class="youtube-player" type="text/html" src="//www.youtube.com/embed/'.$this->get_youtube_ref_from_url().'?autoplay='.$this->autoplay.'&rel=0" frameborder="0"></iframe>';
  }
