...
add_action( 'customize_register', 'cactus_cactus_settings_repeater_setting' );
function cactus_cactus_settings_repeater_setting(){
/**
 * Repeater Settings.
 */
class Cactus_Settings_Repeater_Setting extends WP_Customize_Setting {
