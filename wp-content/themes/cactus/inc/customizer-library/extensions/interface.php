			...
			if ( isset( $option['type'] ) ) {
				...
				switch ( $option['type'] ) {
					...
					case 'line':
						...
						$wp_customize->add_control(
							new Cactus_Customize_Iconpicker_Control(
								$wp_customize, $option['id'], $option
							)
						);
						...
						$wp_customize->add_control(
							new Cactus_Customize_Control_Radio_Image(
								$wp_customize, $option['id'], $option
							)
						);
						...
						$wp_customize->add_control(
							new Cactus_Customize_Control_Multiple_Select(
								$wp_customize, $option['id'], $option
							)
						);
						...
						case 'cactus_editor':
						$wp_customize->add_control(
							new Cactus_Customize_Editor_Control(
								$wp_customize, $option['id'], $option
							)
						);
						break;
