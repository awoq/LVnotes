...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'cactus' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'cactus' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'cactus' ),
		'cyrillic'     => __( 'Cyrillic', 'cactus' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'cactus' ),
		'devanagari'   => __( 'Devanagari', 'cactus' ),
		'greek'        => __( 'Greek', 'cactus' ),
		'greek-ext'    => __( 'Greek Extended', 'cactus' ),
		'khmer'        => __( 'Khmer', 'cactus' ),
		'latin'        => __( 'Latin', 'cactus' ),
		'latin-ext'    => __( 'Latin Extended', 'cactus' ),
		'vietnamese'   => __( 'Vietnamese', 'cactus' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'cactus' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'cactus' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'cactus' ),
